      ...
      <ul>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/linear_spline_lme_tutorial/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Linear spline LME models with <code>lme4</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/natural_spline_lme_tutorial/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Natural spline LME models with <code>lme4</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/ps_psme/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">P-spline LME models with <code>psme</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/sitar/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">SITAR models with <code>sitar</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/bsitar/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Bayesian SITAR models with <code>bsitar</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/gbtm_lcmm/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Group-based trajectory models with <code>lcmm</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/gmm_lcmm/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Growth mixture models with <code>lcmm</code></h3>
        ...
        <li>
          <a href="{{ site.baseurl }}/training/tutorials/fpca_face/" class="tutorial-link">
            <h3 class="h5 mb-1 tutorial-title">Functional principal component analysis with <code>face</code></h3>
